#include "show_camera_preview.h"
#include "texture/stb_image_aug.h"
#include "tiny_obj_loader.h"


void ShowCameraPreview::OnCreate()
{
    m_mesh = NULL;
}

void ShowCameraPreview::OnDestroy()
{
}



void ShowCameraPreview::Load(const std::string& strModelFile, const std::string& strModelDir)
{
...
void ShowCameraPreview::OnRender(RenderContext* pCxt)
{
    // only care about normal render
